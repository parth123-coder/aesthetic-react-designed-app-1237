        ...
        <section className="relative min-h-[100vh] md:min-h-[110vh] flex flex-col items-center pt-24 md:pt-32 pb-20 overflow-hidden bg-brand-dark">
            <div className="text-center z-20 max-w-4xl mx-auto px-4 mb-16">
                <motion.p
                    ...
                    className="text-brand-yellow font-bold tracking-widest text-[10px] md:text-xs mb-6 uppercase"
                >
                ...
                <motion.h1
                    ...
                    className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-display font-black leading-[0.9] tracking-tighter mb-8 md:mb-10"
                >
                    THE MODERN<br />WAY TO LIVE
                </motion.h1>
                <motion.button
            ...
            <div className="relative w-full max-w-[1200px] h-auto md:h-[800px] hero-perspective flex justify-center px-4 md:px-0">
                ...
                >
                    ...
                    <h3 className="font-display font-bold text-lg leading-tight mb-2">Quickly discover what's nearby</h3>
